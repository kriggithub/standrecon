...
[![CRAN status](https://www.r-pkg.org/badges/version/standrecon)](https://CRAN.R-project.org/package=standrecon)
<!-- badges: end -->
...
Alternatively, can install the development version of standrecon from [GitHub](https://github.com/) with:
